...
kernel_css <- HTML("
  ...
  /* Navbar */
  .navbar { background: linear-gradient(135deg, #1B3D66 0%, #2484F2 100%) !important; border: none !important; box-shadow: 0 2px 12px rgba(27,61,102,0.18); }
...
note_div <- function(..., color = "#2484F2") {
  div(class = "section-note", style = paste0("border-left-color:", color, ";"), ...)
}

ui <- navbarPage(
  title = span(tags$img(src="data:image/svg+xml;base64,", height="30px", style="vertical-align:middle;")),
  id = "main_nav",
  theme = bs_theme(version = 5, bootswatch = "flatly"),
  header = tags$head(tags$style(kernel_css)),
  windowTitle = "KernelStats \u2014 Statistical Analysis Platform",
  ...
  navbarMenu("Model", icon = icon("chart-line"),
    ...
    tabPanel("Time Series",
      note_div(h4(icon("chart-line"), " Time Series Analysis"), p("ARIMA, GARCH, stationarity tests, and forecasting."), color="#2484F2"),
      fluidRow(
...
server <- function(input, output, session) {
  ...
  output$miss_plot <- renderPlot({ df<-doctor_data();req(df);prof<-column_profile(df); ggplot(prof,aes(x=reorder(variable,missing_pct),y=missing_pct))+geom_col(fill="#2484F2",alpha=0.8)+coord_flip()+labs(x=NULL,y="Missing %")+scale_y_continuous(labels=label_percent(scale=1))+theme_kernel() })
  output$type_plot <- renderPlot({ df<-doctor_data();req(df);prof<-column_profile(df);tc<-prof|>count(type,sort=TRUE); ggplot(tc,aes(x=reorder(type,n),y=n))+geom_col(fill="#2484F2",alpha=0.8)+coord_flip()+labs(x=NULL,y="Count",title="Variable Types")+theme_kernel() })
  ...
  output$doc_card_info <- renderUI({ f<-doc_findings();n<-sum(f$severity=="info"); div(class="stat-card",style="border-left:4px solid #2484F2;",div(class="label","Info"),div(class="value",style="color:#2484F2;",n)) })
  ...
  output$doc_table <- renderDT({
    ...
    dd$severity <- ifelse(f$severity=="critical",'<span style="color:#DC3545;font-weight:700;">CRITICAL</span>',ifelse(f$severity=="warning",'<span style="color:#FD7E14;font-weight:700;">WARNING</span>','<span style="color:#2484F2;">INFO</span>'))
  ...
  output$uni_plot_out <- renderPlot({
    ...
    if(chosen=="Histogram"){validate(need(is.numeric(x),"Need numeric.")); ggplot(df,aes(x=.data[[var]]))+geom_histogram(bins=30,fill="#2484F2",alpha=0.7,color="white")+labs(title=paste("Histogram:",var))+theme_kernel()}
    else if(chosen=="Density"){validate(need(is.numeric(x),"Need numeric.")); ggplot(df,aes(x=.data[[var]]))+geom_density(fill="#2484F2",alpha=0.3,color="#2484F2",linewidth=1)+labs(title=paste("Density:",var))+theme_kernel()}
    else if(chosen=="Boxplot"){validate(need(is.numeric(x),"Need numeric.")); ggplot(df,aes(y=.data[[var]],x=""))+geom_boxplot(fill="#2484F2",alpha=0.3,color="#2484F2")+labs(title=paste("Boxplot:",var))+theme_kernel()}
    else { ggplot(data.frame(v=coerce_categorical(x)),aes(x=v))+geom_bar(fill="#2484F2",alpha=0.8)+coord_flip()+labs(title=paste("Bar:",var))+theme_kernel()}
  })
  ...
  output$bi_plot <- renderPlot({
    ...
    if(xn&&yn){p<-ggplot(pd,aes(x=.data[[xv]],y=.data[[yv]]))+geom_point(alpha=0.5,color="#6F42C1"); if(pt%in%c("Auto","Scatter+Linear"))p<-p+geom_smooth(method="lm",se=TRUE,color="#DC3545"); if(pt=="Scatter+Loess")p<-p+geom_smooth(method="loess",se=TRUE,color="#2484F2"); p+labs(title=paste(yv,"vs.",xv))+theme_kernel()}
  ...
  output$norm_qq <- renderPlot({ nr<-norm_r();x<-nr$x;n<-length(x); ggplot(data.frame(t=qnorm(ppoints(n)),s=sort(x)),aes(x=t,y=s))+geom_point(alpha=0.5,color="#D63384")+geom_abline(intercept=mean(x),slope=sd(x),linetype="dashed",color="#2484F2")+labs(title="Q-Q Plot",x="Theoretical",y="Sample")+theme_kernel() })
  output$norm_hist <- renderPlot({ nr<-norm_r();x<-nr$x; ggplot(data.frame(x=x),aes(x=x))+geom_histogram(aes(y=after_stat(density)),bins=30,fill="#D63384",alpha=0.4,color="white")+geom_density(linewidth=1.2,color="#D63384")+stat_function(fun=dnorm,args=list(mean=mean(x),sd=sd(x)),linetype="dashed",color="#2484F2")+labs(title="Distribution",x=nr$var)+theme_kernel() })
  ...
  output$mod_coef_plot <- renderPlot({ fit<-fitted_model();ct<-extract_coefficients(fit);ct<-ct[!grepl("Intercept|\\|",ct$term),];validate(need(nrow(ct)>0,"No coefficients.")); ggplot(ct,aes(x=reorder(term,estimate),y=estimate,ymin=conf_low,ymax=conf_high))+geom_pointrange(color="#2484F2",linewidth=0.8)+coord_flip()+labs(x=NULL,y="Estimate",title="Coefficient Plot")+theme_kernel() })

  output$diag_resid <- renderPlot({ fit<-fitted_model();req(inherits(fit,"lm")); ggplot(data.frame(f=fitted(fit),r=residuals(fit)),aes(x=f,y=r))+geom_point(alpha=0.5,color="#6F42C1")+geom_hline(yintercept=0,linetype="dashed",color="#DC3545")+geom_smooth(method="loess",se=FALSE,color="#2484F2")+labs(title="Residuals vs Fitted")+theme_kernel() })
  ...
  output$diag_scale <- renderPlot({ fit<-fitted_model();req(inherits(fit,"lm")); ggplot(data.frame(f=fitted(fit),s=sqrt(abs(rstandard(fit)))),aes(x=f,y=s))+geom_point(alpha=0.5,color="#6F42C1")+geom_smooth(method="loess",se=FALSE,color="#2484F2")+labs(title="Scale-Location")+theme_kernel() })
  ...
  output$multi_plot <- renderPlot({
    res<-multi_result()
    if(res$method=="PCA"){sc<-as.data.frame(res$fit$x[,1:2]);ggplot(sc,aes(PC1,PC2))+geom_point(alpha=0.7,color="#2484F2")+labs(title="PCA Scores")+theme_kernel()}
    else if(res$method%in%c("MCA","FAMD")){co<-as.data.frame(res$fit$ind$coord[,1:2]);names(co)<-c("D1","D2");ggplot(co,aes(D1,D2))+geom_point(alpha=0.7,color="#2484F2")+labs(title=paste(res$method,"Map"))+theme_kernel()}
  ...
  output$multi_dendro <- renderPlot({
    ...
    nu<-min(nrow(num),200);if(nrow(num)>200)num<-num[sample(nrow(num),200),];hc<-hclust(dist(scale(num)),method="ward.D2");plot(hc,labels=FALSE,main="Dendrogram",sub="",hang=-1);if(!is.null(input$multi_k))rect.hclust(hc,k=input$multi_k,border=c("#DC3545","#2484F2","#198754","#FD7E14","#6F42C1"))
  })
  ...
  output$arima_fc <- renderPlot({ af<-arima_r();plot(af$fc,main=paste("ARIMA Forecast:",af$data$name),xlab="Time",ylab=af$data$name,col="#2484F2",fcol="#DC3545",lwd=2) })
  output$arima_resid <- renderPlot({ af<-arima_r();r<-residuals(af$fit); ggplot(data.frame(x=r),aes(x=x))+geom_histogram(aes(y=after_stat(density)),bins=30,fill="#2484F2",alpha=0.5,color="white")+geom_density(linewidth=1,color="#2484F2")+stat_function(fun=dnorm,args=list(mean=mean(r),sd=sd(r)),linetype="dashed",color="#DC3545")+labs(title="ARIMA Residuals")+theme_kernel() })
  ...
  output$km_plot <- renderPlot({ km<-km_r(); if(has_pkg("survminer"))print(survminer::ggsurvplot(km$fit,pval=!is.null(km$lr),conf.int=TRUE,ggtheme=theme_kernel())) else{plot(km$fit,col=c("#2484F2","#DC3545","#198754","#FD7E14"),lwd=2,main="Kaplan-Meier Curve")} })
  ...
  # ── ML Pipeline ──
  output$ml_task_card <- renderUI({ df<-doctor_data();req(df,input$ml_y);task<-ml_detect_task(df[[input$ml_y]]);cl<-if(task=="classification")"#6F42C1" else "#2484F2"; div(class="stat-card",style=paste0("border-left:4px solid ",cl,";"),div(class="label","Task"),div(class="value",style=paste0("color:",cl,";font-size:1.2rem;"),toupper(task))) })
  ...
  output$doe_plot <- renderPlot({ des<-gen_doe_r();req(des);validate(need(ncol(des)>=2,"Need 2+ cols.")); pd<-des;pd$.run<-seq_len(nrow(pd)); ggplot(pd,aes(.data[[names(pd)[1]]],.data[[names(pd)[2]]],label=.run))+geom_point(size=3,color="#2484F2")+geom_text(vjust=-0.7,size=3)+labs(title="Design Map")+theme_kernel() })
  ...
  output$doe_effects <- renderPlot({ res<-doe_r();df<-res$data;resp<-input$doe_resp;fcts<-input$doe_factors; edf<-purrr::map_dfr(fcts,function(f){df|>mutate(.lev=as.factor(.data[[f]]))|>group_by(.lev)|>summarise(mean_r=mean(.data[[resp]],na.rm=TRUE),.groups="drop")|>mutate(factor=f)}); ggplot(edf,aes(.lev,mean_r,group=1))+geom_line(color="#2484F2")+geom_point(size=2.5,color="#2484F2")+facet_wrap(~factor,scales="free_x")+labs(title="Main Effects",x="Level",y=paste("Mean",resp))+theme_kernel() })
    ...
    content = function(file) {
      ...
      if (fmt == "md") {
        ...
        html <- paste0(
          ...
          'h1{color:#1B3D66;border-bottom:3px solid #2484F2;padding-bottom:8px;}',
          'h2{color:#2484F2;margin-top:2em;}',
  ...
  output$code_export <- renderText({
    ...
    paste(c(
      ...
      "# Univariate EDA",
      "# ggplot(df, aes(x = var)) + geom_histogram(bins = 30, fill = '#2484F2')", "",
      "# Regression",
  ...
  output$spc_chart <- renderPlot({ cc<-spc_r();ooc<-cc$values>cc$ucl|cc$values<cc$lcl; ggplot(data.frame(i=cc$index,v=cc$values,o=ooc),aes(i,v))+geom_line(color="#2484F2",linewidth=0.7)+geom_point(aes(color=o),size=2,show.legend=FALSE)+scale_color_manual(values=c("FALSE"="#2484F2","TRUE"="#DC3545"))+geom_hline(yintercept=cc$cl,color="#198754",linewidth=1)+geom_hline(yintercept=c(cc$ucl,cc$lcl),linetype="dashed",color="#DC3545")+labs(title=paste("Control Chart:",cc$type),x="Observation",y=input$spc_var)+theme_kernel() })
  ...
  output$cap_plot <- renderPlot({ cr<-cap_r(); ggplot(data.frame(x=cr$x),aes(x=x))+geom_histogram(aes(y=after_stat(density)),bins=30,fill="#2484F2",alpha=0.5,color="white")+geom_density(linewidth=1.2,color="#2484F2")+geom_vline(xintercept=c(cr$lsl,cr$usl),linetype="dashed",color="#DC3545",linewidth=1)+geom_vline(xintercept=mean(cr$x),color="#198754",linewidth=1)+labs(title="Process Capability")+theme_kernel() })
  ...
  output$rfm_seg <- renderPlot({ rfm<-rfm_r();sc<-rfm|>count(segment,sort=TRUE); ggplot(sc,aes(reorder(segment,n),n,fill=segment))+geom_col(show.legend=FALSE,alpha=0.85)+coord_flip()+scale_fill_manual(values=c("Champions"="#198754","Regular"="#2484F2","New"="#14B8A6","At risk"="#FD7E14","Lost"="#DC3545"))+labs(title="Customer Segments",x=NULL,y="Count")+theme_kernel() })
  output$rfm_scatter <- renderPlot({ rfm<-rfm_r(); ggplot(rfm,aes(recency,monetary,size=frequency,color=segment))+geom_point(alpha=0.6)+scale_size_continuous(range=c(2,10))+scale_color_manual(values=c("Champions"="#198754","Regular"="#2484F2","New"="#14B8A6","At risk"="#FD7E14","Lost"="#DC3545"))+labs(title="RFM Scatter")+theme_kernel() })
  output$rfm_heat <- renderPlot({ rfm<-rfm_r();hd<-rfm|>group_by(R_score,F_score)|>summarise(m=mean(monetary,na.rm=TRUE),.groups="drop"); ggplot(hd,aes(factor(F_score),factor(R_score),fill=m))+geom_tile(color="white")+geom_text(aes(label=round(m,0)),size=3.5)+scale_fill_gradient(low="#EBF1F9",high="#2484F2")+labs(title="RFM Heatmap",x="Frequency Score",y="Recency Score")+theme_kernel()+theme(panel.grid=element_blank()) })
